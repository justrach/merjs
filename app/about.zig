...
const html =
    ...
    \\  <meta name="description" content="merjs is a Zig-native web framework exploring whether systems languages and WASM can replace Node.js for web development.">
    \\  <meta property="og:type" content="website">
    \\  <meta property="og:site_name" content="merjs">
    \\  <meta property="og:title" content="About merjs — The Zig Web Framework">
    \\  <meta property="og:description" content="One language, two targets. Server compiles to native binary, client compiles to WASM.">
    \\  <meta name="twitter:card" content="summary_large_image">
    \\  <meta name="twitter:title" content="About merjs — The Zig Web Framework">
    \\  <meta name="twitter:description" content="One language, two targets. Zero node_modules.">
