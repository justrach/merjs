...
fn page() h.Node {
    return h.div(.{ .class = "wrap" }, .{
        ...
        h.div(.{ .class = "buttons" }, .{
            h.button(.{ .id = "btn-dec", .class = "btn" }, "\u{2212}"),
            h.button(.{ .id = "btn-reset", .class = "btn btn-reset" }, "reset"),
            h.button(.{ .id = "btn-inc", .class = "btn btn-inc" }, "+"),
        }),
