...
fn page() h.Node {
    return h.div(.{ .class = "page" }, .{
        ...
        h.div(.{ .class = "bench" }, .{
            ...
            benchRow("Requests / sec", "90%", "2410.34 req/s", "67%", "1805.16 req/s"),
            benchRow("Avg Latency", "47%", "41.36 ms", "90%", "78.07 ms"),
            benchRow("RAM Usage", "90%", "~453.7 MB", "14%", "~73.1 MB"),
            benchRow("Build Time", "8%", "~4.4 s", "90%", "~49 s"),
