...
fn page() h.Node {
    return h.div(.{ .class = "page" }, .{
        ...
        h.div(.{ .class = "bench" }, .{
            ...
            benchRow("Requests / sec", "90%", "2432.27 req/s", "76%", "2061.12 req/s"),
            benchRow("Avg Latency", "49%", "40.99 ms", "90%", "74.24 ms"),
            benchRow("RAM Usage", "90%", "~447.2 MB", "14%", "~72.5 MB"),
            benchRow("Build Time", "21%", "~10.1 s", "90%", "~43 s"),
