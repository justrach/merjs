//! design.zig — Tailwind-inspired design tokens for merjs.
//!
//! Type-safe compile-time tokens:
...
//!
//! Ported from yxlyx #92 / #95 (mercss Tailwind parity). Existing
//! `mercss.DesignSystem` stays for backward compatibility.
...
fn ColorScale(
    comptime hex_50: []const u8,
    comptime hex_100: []const u8,
    comptime hex_200: []const u8,
    comptime hex_300: []const u8,
    comptime hex_400: []const u8,
    comptime hex_500: []const u8,
    comptime hex_600: []const u8,
    comptime hex_700: []const u8,
    comptime hex_800: []const u8,
    comptime hex_900: []const u8,
    comptime hex_950: []const u8,
) type {
    return struct {
