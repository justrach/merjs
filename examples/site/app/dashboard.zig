...
const html_bottom =
    ...
    \\  const ssrD = new Date(effectiveTs * 1000);
    \\  document.getElementById('ssr-human').textContent = ssrD.toLocaleTimeString();
    \\  document.getElementById('ssr-iso').textContent = ssrD.toISOString();
    \\</script>
;
