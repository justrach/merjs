...
<!-- BENCH:START -->
| Requests/sec (wrk)    | **2409.15 req/s**     | **1895.02 req/s**          |
| Avg latency           | **41.38ms 3.15ms**           | **77.63ms 173.06ms**                |
| RAM usage (under load) | **431.3 MB**        | **74.1 MB**             |
| Build time             | **2422 ms**                | **41898 ms**                   |
<!-- BENCH:END -->
