...
<!-- BENCH:START -->
| Requests/sec (wrk)    | **2437.43 req/s**     | **1908.89 req/s**          |
| Avg latency           | **40.86ms 2.42ms**           | **76.41ms 169.17ms**                |
| RAM usage (under load) | **454.3 MB**        | **72.6 MB**             |
| Build time             | **7850 ms**                | **49225 ms**                   |
<!-- BENCH:END -->
