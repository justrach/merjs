...
| ---------------------- | -------------------------- | ------------------------------ |
<!-- BENCH:START -->
| Requests/sec (wrk)    | **2435.15 req/s**     | **2468.83 req/s**          |
| Avg latency           | **40.93ms 1.31ms**           | **75.90ms 192.50ms**                |
| RAM usage (under load) | **10.0 MB**        | **70.9 MB**             |
| Build time             | **5339 ms**                | **34791 ms**                   |
<!-- BENCH:END -->
