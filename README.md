...
<!-- BENCH:START -->
| Requests/sec (wrk)    | **2437.25 req/s**     | **1967.41 req/s**          |
| Avg latency           | **40.88ms 2.49ms**           | **76.66ms 173.91ms**                |
| RAM usage (under load) | **427.7 MB**        | **73.2 MB**             |
| Build time             | **7211 ms**                | **48027 ms**                   |
<!-- BENCH:END -->
