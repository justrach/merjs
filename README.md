...
| ---------------------- | -------------------------- | ------------------------------ |
<!-- BENCH:START -->
| Requests/sec (wrk)    | **2434.54 req/s**     | **2517.11 req/s**          |
| Avg latency           | **40.96ms 1.22ms**           | **74.48ms 189.90ms**                |
| RAM usage (under load) | **9.1 MB**        | **72.8 MB**             |
| Build time             | **12145 ms**                | **30040 ms**                   |
<!-- BENCH:END -->
