...
| ---------------------- | -------------------------- | ------------------------------ |
<!-- BENCH:START -->
| Requests/sec (wrk)    | **9159.99 req/s**     | **2145.37 req/s**          |
| Avg latency           | **0.87ms 429.35us**           | **77.07ms 182.52ms**                |
| RAM usage (under load) | **3.6 MB**        | **72.0 MB**             |
| Build time             | **1244 ms**                | **28014 ms**                   |
<!-- BENCH:END -->
