...
| ---------------------- | -------------------------- | ------------------------------ |
<!-- BENCH:START -->
| Requests/sec (wrk)    | **9291.22 req/s**     | **2080.06 req/s**          |
| Avg latency           | **0.85ms 407.22us**           | **77.94ms 181.87ms**                |
| RAM usage (under load) | **3.7 MB**        | **72.3 MB**             |
| Build time             | **1293 ms**                | **30516 ms**                   |
<!-- BENCH:END -->
