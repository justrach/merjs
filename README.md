...
| ---------------------- | -------------------------- | ------------------------------ |
<!-- BENCH:START -->
| Requests/sec (wrk)    | **2435.88 req/s**     | **2458.70 req/s**          |
| Avg latency           | **40.92ms 1.31ms**           | **74.21ms 187.76ms**                |
| RAM usage (under load) | **9.3 MB**        | **71.6 MB**             |
| Build time             | **105589 ms**                | **35241 ms**                   |
<!-- BENCH:END -->
