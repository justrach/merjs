...
| ---------------------- | -------------------------- | ------------------------------ |
<!-- BENCH:START -->
| Requests/sec (wrk)    | **195.16 req/s**     | **2391.62 req/s**          |
| Avg latency           | **40.85ms 2.35ms**           | **74.94ms 187.22ms**                |
| RAM usage (under load) | **20.4 MB**        | **72.0 MB**             |
| Build time             | **27112 ms**                | **32214 ms**                   |
<!-- BENCH:END -->
